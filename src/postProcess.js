...
import vShader from './shaders/pVertex.glsl';
import fShader from './shaders/pFragment.glsl';
...
//   0.35 //default value = 1.0
// );

// unrealBloomPass.strength = 0.35; //strength
// unrealBloomPass.radius = 0.0; //radius
// unrealBloomPass.threshold = 0.45; //glow
